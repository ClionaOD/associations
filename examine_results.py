...
rules_one = pd.read_csv('./results/association_rules_one.csv', sep=',')
rules_four = pd.read_csv('./results/association_rules_four.csv', sep=',')
rules_seven = pd.read_csv('./results/association_rules_seven.csv', sep=',')
rules_ten = pd.read_csv('./results/association_rules_ten.csv', sep=',')
